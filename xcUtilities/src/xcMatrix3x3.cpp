...
namespace xcEngineSDK {
  ...
  //  //up vector
  //  m_matrix.mv[0].m_x = R00;
  //  m_matrix.mv[0].m_y = R01;
  //  m_matrix.mv[0].m_z = R02;

  //  //middle vector  
  //  m_matrix.mv[1].m_x = R10;
  //  m_matrix.mv[1].m_y = R11;
  //  m_matrix.mv[1].m_z = R12;

  //  //down vector    
  //  m_matrix.mv[2].m_x = R20;
  //  m_matrix.mv[2].m_y = R21;
  //  m_matrix.mv[2].m_z = R22;
...
//  Matrix3x3::transpose() {
//
//    return *this;/*Matrix3x3(m_matrix[0][0], m_matrix[1][0], m_matrix[2][0],
